    ...
    for (x,y,w,h) in faces :
        ...
        if len(eyes) == 2 :
            ...
            if height_sunglasses != 0 and width_sunglasses != 0 :
                ...
                sunglasses_resize = cv2.resize(sunglasses, (width_sunglasses, height_sunglasses))
                alpha_sunglasses_resize = cv2.resize(alpha_sunglasses, (width_sunglasses, height_sunglasses))
                ...
                offset_y = int(height_sunglasses * 1)  # Ajustez la valeur selon votre besoin
